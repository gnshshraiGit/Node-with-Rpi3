...
Result:- These is very much similar to sample 3 other than we are using a simple http server to get the commands via webpage link clicks over websockets, 
and this is just one part of a three layer system <br/>
